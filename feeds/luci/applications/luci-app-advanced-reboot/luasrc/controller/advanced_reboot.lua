...
for i=1, #devices do
  if board_name and devices[i][2] == board_name then
    ...
    if string.find(partition_one_label, "BoluWrt") then partition_one_os = "BoluWrt" end
    if string.find(partition_one_label, "BoluWrt") then partition_one_os = "BoluWrt" end
    if string.find(partition_one_label, "Linksys") then partition_one_os = "Linksys" end
    if string.find(partition_two_label, "BoluWrt") then partition_two_os = "BoluWrt" end
    if string.find(partition_two_label, "BoluWrt") then partition_two_os = "BoluWrt" end
