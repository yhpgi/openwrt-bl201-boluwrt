...
or the [BoluWrt Development List](https://lists.openwrt.org/boluwrt/mailman/listinfo/openwrt-devel).

If you send via the BoluWrt list, include a "[luci]" tag in your subject line.
For general information on patch submission, follow the [BoluWrt patch submission guideline](https://dev.openwrt.org/wiki/SubmittingPatches).
