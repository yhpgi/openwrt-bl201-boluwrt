...
A logical combination of AP+STA mode on one physical radio allows most of BoluWrt/BoluWrt supported router devices to connect to a wireless hotspot/station (STA) and provide a wireless access point (AP) from that hotspot at the same time. Downside of this solution: whenever the STA interface looses the connection it will go into an active scan cycle which renders the radio unusable for AP mode operation, therefore the AP is taken down if the STA looses its association.  
...
* easy setup within normal BoluWrt/BoluWrt environment
...
## Prerequisites
* [BoluWrt](https://openwrt.org) or [BoluWrt](https://www.lede-project.org) trunk
* iw (default) or iwinfo for wlan scanning

## BoluWrt / BoluWrt trunk Installation & Usage
